...
function AddItemModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-[#F5F1E8] rounded-2xl p-5 w-72 shadow-lg animate-scale-in">
...
export function PantryPage({ onBack }: PantryPageProps) {
  ...
  const overlay = (
    <div className="fixed inset-0 z-[60] flex w-full max-w-none flex-col overflow-hidden bg-[#F5F1E8] paper-bg pt-[env(safe-area-inset-top)] [height:100dvh] max-h-[100dvh]">
      <div className="relative shrink-0 overflow-hidden bg-[#A67B5B] px-5 py-4">
        ...
        <div className="flex items-center justify-between relative z-10">
          <button onClick={onBack} className="text-[#F5EFE6]/80 hover:text-[#F5EFE6] btn-press">
      ...
      <div className="flex shrink-0 items-center overflow-x-auto border-b border-[#C9C5BD] bg-[#F5F1E8] scrollbar-hide">
